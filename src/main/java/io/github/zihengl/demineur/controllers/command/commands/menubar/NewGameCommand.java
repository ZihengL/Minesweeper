...
import io.github.zihengl.demineur.controllers.CellComponent;
    ...
    public void handle(ActionEvent event) {
        ...
        for (int y = 0; y < grid.getHeight(); y++)
            for (int x = 0; x < grid.getWidth(); x++) {
                ...
                grid.getCell(x, y).setObserver(cellComponent);
                this.container.add(cellComponent, y, x);
            }
